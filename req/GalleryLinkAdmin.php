	...
	<!--
	 ...
	 -->
	  ...
	  <div id="tabs-1">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[type] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[type] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[type] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[type] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[type] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[type] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[sort] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[sort] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[sort] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[sort] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[sort] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[sort] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[effect_pc] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[effect_pc] ?></td>
		<td colspan="2" align="center" valign="middle" bgcolor="#dddddd"></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[effect_pc] ?></td>
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[effect_sp] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[effect_sp] ?></td>
		<td colspan="2" align="center" valign="middle" bgcolor="#dddddd"></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[effect_sp] ?></td>
		<td bgcolor="#dddddd"></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[topurl] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[topurl] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[topurl] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[topurl] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[topurl] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[topurl] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[suffix_pc] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[suffix_pc] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[suffix_pc] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[suffix_pc] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[suffix_pc] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[suffix_pc2] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[suffix_pc2] ?></td>
		...
		<td align="center" valign="middle" bgcolor="#dddddd"></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[suffix_flash] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[suffix_flash] ?></td>
		<td colspan="2" bgcolor="#dddddd"></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[suffix_sp] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[suffix_sp] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[suffix_sp] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[suffix_sp] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[suffix_sp] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[suffix_keitai] ?></td>
		<?php if ( get_option('gallerylink_movie')[type] === 'dir' ) { ?>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[suffix_keitai] ?></td>
		<?php } else { ?>
			<td bgcolor="#dddddd"></td>
		<?php } ?>
		<?php if ( get_option('gallerylink_music')[type] === 'dir' ) { ?>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[suffix_keitai] ?></td>
		<?php } else { ?>
			<td bgcolor="#dddddd"></td>
		<?php } ?>
		<td align="center" valign="middle" bgcolor="#dddddd"></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[suffix_keitai] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_all')[display_pc]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_album')[display_pc]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_movie')[display_pc]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_music')[display_pc]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_slideshow')[display_pc]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_document')[display_pc]) ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_all')[display_sp]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_album')[display_sp]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_movie')[display_sp]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_music')[display_sp]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_slideshow')[display_sp]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_document')[display_sp]) ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_all')[display_keitai]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_album')[display_keitai]) ?></td>
		<?php if ( get_option('gallerylink_movie')[type] === 'dir' ) { ?>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_movie')[display_keitai]) ?></td>
		<?php } else { ?>
			<td bgcolor="#dddddd"></td>
		<?php } ?>
		<?php if ( get_option('gallerylink_music')[type] === 'dir' ) { ?>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_music')[display_keitai]) ?></td>
		<?php } else { ?>
			<td bgcolor="#dddddd"></td>
		<?php } ?>
		<td align="center" valign="middle" bgcolor="#dddddd"></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_document')[display_keitai]) ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[image_show_size] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[image_show_size] ?></td>
		<td colspan="2" bgcolor="#dddddd"></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[image_show_size] ?></td>
		<td bgcolor="#dddddd"></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><div>dir:<?php echo get_option('gallerylink_album')[thumbnail] ?></div><div>media:-<?php echo get_option('thumbnail_size_w') ?>x<?php echo get_option('thumbnail_size_h') ?></div></td>
		<td align="center" valign="middle"><div>dir:<?php echo get_option('gallerylink_album')[thumbnail] ?></div><div>media:-<?php echo get_option('thumbnail_size_w') ?>x<?php echo get_option('thumbnail_size_h') ?></div></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[thumbnail] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[thumbnail] ?></td>
		<td align="center" valign="middle"><div>dir:<?php echo get_option('gallerylink_slideshow')[thumbnail] ?></div><div>media:-<?php echo get_option('thumbnail_size_w') ?>x<?php echo get_option('thumbnail_size_h') ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[thumbnail] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[include_cat] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[include_cat] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[include_cat] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[include_cat] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[include_cat] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[include_cat] ?></td>
		<td align="left" valign="middle">
		<div><b><font color="red"><?php _e('Use only', 'gallerylink'); ?> type=&#39;media&#39;</font></b></div>
		...
		<td colspan="6" align="center" valign="middle"><?php echo get_option('gallerylink_exclude')[cat] ?></td>
		<td align="left" valign="middle">
		<div><b><font color="red"><?php _e('Use only', 'gallerylink'); ?> type=&#39;media&#39;</font></b></div>
		...
		<td colspan="6" align="center" valign="middle"><?php echo get_option('gallerylink_exclude')[file] ?></td>
		<td align="left" valign="middle">
		<div><b><font color="red"><?php _e('Use only', 'gallerylink'); ?> type=&#39;dir&#39;</font></b></div>
		...
		<td colspan="6" align="center" valign="middle"><?php echo get_option('gallerylink_exclude')[dir] ?></td>
		<td align="left" valign="middle">
		<div><b><font color="red"><?php _e('Use only', 'gallerylink'); ?> type=&#39;dir&#39;</font></b></div>
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[generate_rssfeed] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[generate_rssfeed] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[generate_rssfeed] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[generate_rssfeed] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[generate_rssfeed] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[generate_rssfeed] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[rssname] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[rssname] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[rssname] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[rssname] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[rssname] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[rssname] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_all')[rssmax]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_album')[rssmax]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_movie')[rssmax]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_music')[rssmax]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_slideshow')[rssmax]) ?></td>
		<td align="center" valign="middle"><?php echo intval(get_option('gallerylink_document')[rssmax]) ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[filesize_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[filesize_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[filesize_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[filesize_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[filesize_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[filesize_show] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[stamptime_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[stamptime_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[stamptime_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[stamptime_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[stamptime_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[stamptime_show] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[selectbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[selectbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[selectbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[selectbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[selectbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[selectbox_show] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[pagelinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[pagelinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[pagelinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[pagelinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[pagelinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[pagelinks_show] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[sortlinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[sortlinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[sortlinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[sortlinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[sortlinks_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[sortlinks_show] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[searchbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[searchbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[searchbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[searchbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[searchbox_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[searchbox_show] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[rssicon_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[rssicon_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[rssicon_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[rssicon_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[rssicon_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[rssicon_show] ?></td>
		<td align="left" valign="middle">
		...
		<td align="center" valign="middle"><?php echo get_option('gallerylink_all')[credit_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_album')[credit_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_movie')[credit_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_music')[credit_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_slideshow')[credit_show] ?></td>
		<td align="center" valign="middle"><?php echo get_option('gallerylink_document')[credit_show] ?></td>
		<td align="left" valign="middle">
		...
		<div class="wrap">
			...
			<tbody>
				...
				<tr>
					<td align="center" valign="middle"><b>type</b></td>
					<td align="center" valign="middle">
					<?php $target_all_type = get_option('gallerylink_all')[type]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_type = get_option('gallerylink_album')[type]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_type = get_option('gallerylink_movie')[type]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_type = get_option('gallerylink_music')[type]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_type = get_option('gallerylink_slideshow')[type]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_type = get_option('gallerylink_document')[type]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>sort</b></td>
					<td align="center" valign="middle">
					<?php $target_all_sort = get_option('gallerylink_all')[sort]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_sort = get_option('gallerylink_album')[sort]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_sort = get_option('gallerylink_movie')[sort]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_sort = get_option('gallerylink_music')[sort]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_sort = get_option('gallerylink_slideshow')[sort]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_sort = get_option('gallerylink_document')[sort]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>effect_pc</b></td>
					<td align="center" valign="middle">
					<?php $target_all_effect_pc = get_option('gallerylink_all')[effect_pc]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_effect_pc = get_option('gallerylink_album')[effect_pc]; ?>
					...
					<td colspan="2"></td>
					<td align="center" valign="middle">
					<?php $target_slideshow_effect_pc = get_option('gallerylink_slideshow')[effect_pc]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>effect_sp</b></td>
					<td align="center" valign="middle">
					<?php $target_all_effect_sp = get_option('gallerylink_all')[effect_sp]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_effect_sp = get_option('gallerylink_album')[effect_sp]; ?>
					...
					<td colspan="2"></td>
					<td align="center" valign="middle">
					<?php $target_slideshow_effect_sp = get_option('gallerylink_slideshow')[effect_sp]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>topurl</b></td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_all_topurl" name="gallerylink_all_topurl" value="<?php echo get_option('gallerylink_all')[topurl] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_album_topurl" name="gallerylink_album_topurl" value="<?php echo get_option('gallerylink_album')[topurl] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_movie_topurl" name="gallerylink_movie_topurl" value="<?php echo get_option('gallerylink_movie')[topurl] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_music_topurl" name="gallerylink_music_topurl" value="<?php echo get_option('gallerylink_music')[topurl] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_slideshow_topurl" name="gallerylink_slideshow_topurl" value="<?php echo get_option('gallerylink_slideshow')[topurl] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_document_topurl" name="gallerylink_document_topurl" value="<?php echo get_option('gallerylink_document')[topurl] ?>" size="15" />
					</td>
					<td align="left" valign="middle">
						<div><b><font color="red"><?php _e('Use only', 'gallerylink'); ?> type=&#39;dir&#39;</font></b></div>
						<?php _e('Full path to the top directory containing the data. Example:In the case of http://www.mysite.xxx/wordpress/wp-content/uploads is /wordpress/wp-content/uploads.', 'gallerylink'); ?>
				...
				<tr>
					...
					<td align="left" valign="top" rowspan="5" width="180"><?php _e("Audio's suffix and Video's suffix is following to the setting(set='music',set='movie'). Other than that, read all the data.", 'gallerylink'); ?></td>
					<td align="center" valign="middle">
					<?php $target_album_suffix_pc = get_option('gallerylink_album')[suffix_pc]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_suffix_pc = get_option('gallerylink_movie')[suffix_pc]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_suffix_pc = get_option('gallerylink_music')[suffix_pc]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_suffix_pc = get_option('gallerylink_slideshow')[suffix_pc]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_suffix_pc = get_option('gallerylink_document')[suffix_pc]; ?>
				...
				<tr>
					...
					<td></td>
					<td align="center" valign="middle">
					<?php $target_movie_suffix_pc2 = get_option('gallerylink_movie')[suffix_pc2]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_suffix_pc2 = get_option('gallerylink_music')[suffix_pc2]; ?>
				...
				<tr>
					...
					<td></td>
					<td align="center" valign="middle">
					<?php $target_movie_suffix_flash = get_option('gallerylink_movie')[suffix_flash]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_suffix_flash = get_option('gallerylink_music')[suffix_flash]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>suffix_sp</b></td>
					<td align="center" valign="middle">
					<?php $target_album_suffix_sp = get_option('gallerylink_album')[suffix_sp]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_suffix_sp = get_option('gallerylink_movie')[suffix_sp]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_suffix_sp = get_option('gallerylink_music')[suffix_sp]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_suffix_sp = get_option('gallerylink_slideshow')[suffix_sp]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_suffix_sp = get_option('gallerylink_document')[suffix_sp]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>suffix_keitai</b></td>
					<td align="center" valign="middle">
					<?php $target_album_suffix_keitai = get_option('gallerylink_album')[suffix_keitai]; ?>
					...
					<?php if ( get_option('gallerylink_movie')[type] === 'dir' ) { ?>
					<td align="center" valign="middle">
					<?php $target_movie_suffix_keitai = get_option('gallerylink_movie')[suffix_keitai]; ?>
					...
					<?php } else { ?>
					<td>
						<input type="hidden" id="gallerylink_movie_suffix_keitai" name="gallerylink_movie_suffix_keitai" value="<?php echo get_option('gallerylink_movie')[suffix_keitai] ?>" />
					</td>
					<?php } ?>
					<?php if ( get_option('gallerylink_music')[type] === 'dir' ) { ?>
					<td align="center" valign="middle">
					<?php $target_music_suffix_keitai = get_option('gallerylink_music')[suffix_keitai]; ?>
					...
					<?php } else { ?>
					<td>
						<input type="hidden" id="gallerylink_music_suffix_keitai" name="gallerylink_music_suffix_keitai" value="<?php echo get_option('gallerylink_music')[suffix_keitai] ?>" />
					</td>
					<?php } ?>
					<td></td>
					<td align="center" valign="middle">
					<?php $target_document_suffix_keitai = get_option('gallerylink_document')[suffix_keitai]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>display_pc</b></td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_all_display_pc" name="gallerylink_all_display_pc" value="<?php echo intval(get_option('gallerylink_all')[display_pc]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_album_display_pc" name="gallerylink_album_display_pc" value="<?php echo intval(get_option('gallerylink_album')[display_pc]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_movie_display_pc" name="gallerylink_movie_display_pc" value="<?php echo intval(get_option('gallerylink_movie')[display_pc]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_music_display_pc" name="gallerylink_music_display_pc" value="<?php echo intval(get_option('gallerylink_music')[display_pc]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_slideshow_display_pc" name="gallerylink_slideshow_display_pc" value="<?php echo intval(get_option('gallerylink_slideshow')[display_pc]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_document_display_pc" name="gallerylink_document_display_pc" value="<?php echo intval(get_option('gallerylink_document')[display_pc]) ?>" size="3" />
					</td>
					<td align="left" valign="middle">
						<?php _e('File Display per page(PC)', 'gallerylink') ?>
					</td>
				...
				<tr>
					<td align="center" valign="middle"><b>display_sp</b></td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_all_display_sp" name="gallerylink_all_display_sp" value="<?php echo intval(get_option('gallerylink_all')[display_sp]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_album_display_sp" name="gallerylink_album_display_sp" value="<?php echo intval(get_option('gallerylink_album')[display_sp]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_movie_display_sp" name="gallerylink_movie_display_sp" value="<?php echo intval(get_option('gallerylink_movie')[display_sp]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_music_display_sp" name="gallerylink_music_display_sp" value="<?php echo intval(get_option('gallerylink_music')[display_sp]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_slideshow_display_sp" name="gallerylink_slideshow_display_sp" value="<?php echo intval(get_option('gallerylink_slideshow')[display_sp]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_document_display_sp" name="gallerylink_document_display_sp" value="<?php echo intval(get_option('gallerylink_document')[display_sp]) ?>" size="3" />
					</td>
					<td align="left" valign="middle">
						<?php _e('File Display per page(Smartphone)', 'gallerylink') ?>
					</td>
				...
				<tr>
					<td align="center" valign="middle"><b>display_keitai</b></td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_all_display_keitai" name="gallerylink_all_display_keitai" value="<?php echo intval(get_option('gallerylink_all')[display_keitai]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_album_display_keitai" name="gallerylink_album_display_keitai" value="<?php echo intval(get_option('gallerylink_album')[display_keitai]) ?>" size="3" />
					</td>
					<?php if ( get_option('gallerylink_movie')[type] === 'dir' ) { ?>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_movie_display_keitai" name="gallerylink_movie_display_keitai" value="<?php echo intval(get_option('gallerylink_movie')[display_keitai]) ?>" size="3" />
					</td>
					<?php } else { ?>
					<td>
						<input type="hidden" id="gallerylink_movie_display_keitai" name="gallerylink_movie_display_keitai" value="<?php echo intval(get_option('gallerylink_movie')[display_keitai]) ?>" />
					</td>
					<?php } ?>
					<?php if ( get_option('gallerylink_music')[type] === 'dir' ) { ?>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_music_display_keitai" name="gallerylink_music_display_keitai" value="<?php echo intval(get_option('gallerylink_music')[display_keitai]) ?>" size="3" />
					</td>
					<?php } else { ?>
					<td>
						<input type="hidden" id="gallerylink_music_display_keitai" name="gallerylink_music_display_keitai" value="<?php echo intval(get_option('gallerylink_music')[display_keitai]) ?>" />
					</td>
					<?php } ?>
					<td></td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_document_display_keitai" name="gallerylink_document_display_keitai" value="<?php echo intval(get_option('gallerylink_document')[display_keitai]) ?>" size="3" />
					</td>
					<td align="left" valign="middle">
						<?php _e('File Display per page(Japanese mobile phone)', 'gallerylink') ?>
					</td>
				...
				<tr>
					<td align="center" valign="middle"><b>image_show_size</b></td>
					<td align="center" valign="middle">
					<?php $target_all_image_show_size = get_option('gallerylink_all')[image_show_size]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_image_show_size = get_option('gallerylink_album')[image_show_size]; ?>
					...
					<td colspan="2"></td>
					<td align="center" valign="middle">
					<?php $target_slideshow_image_show_size = get_option('gallerylink_slideshow')[image_show_size]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>thumbnail</b></td>
					<td align="center" valign="middle">
						<div>dir:<input type="text" id="gallerylink_all_thumbnail" name="gallerylink_all_thumbnail" value="<?php echo get_option('gallerylink_all')[thumbnail] ?>" size="10" /></div>
						<div>media:-<?php echo get_option('thumbnail_size_w') ?>x<?php echo get_option('thumbnail_size_h') ?></div>
					</td>
					<td align="center" valign="middle">
						<div>dir:<input type="text" id="gallerylink_album_thumbnail" name="gallerylink_album_thumbnail" value="<?php echo get_option('gallerylink_album')[thumbnail] ?>" size="10" /></div>
						<div>media:-<?php echo get_option('thumbnail_size_w') ?>x<?php echo get_option('thumbnail_size_h') ?></div>
					</td>
					<td align="center" valign="middle">
					<?php $target_movie_thumbnail = get_option('gallerylink_movie')[thumbnail]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_thumbnail = get_option('gallerylink_music')[thumbnail]; ?>
					...
					<td align="center" valign="middle">
						<div>dir:<input type="text" id="gallerylink_slideshow_thumbnail" name="gallerylink_slideshow_thumbnail" value="<?php echo get_option('gallerylink_slideshow')[thumbnail] ?>" size="10" /></div>
						<div>media:-<?php echo get_option('thumbnail_size_w') ?>x<?php echo get_option('thumbnail_size_h') ?></div>
					</td>
					<td align="center" valign="middle">
					<?php $target_document_thumbnail = get_option('gallerylink_document')[thumbnail]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>include_cat</b></td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_all_include_cat" name="gallerylink_all_include_cat" value="<?php echo get_option('gallerylink_all')[include_cat] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_album_include_cat" name="gallerylink_album_include_cat" value="<?php echo get_option('gallerylink_album')[include_cat] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_movie_include_cat" name="gallerylink_movie_include_cat" value="<?php echo get_option('gallerylink_movie')[include_cat] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_music_include_cat" name="gallerylink_music_include_cat" value="<?php echo get_option('gallerylink_music')[include_cat] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_slideshow_include_cat" name="gallerylink_slideshow_include_cat" value="<?php echo get_option('gallerylink_slideshow')[include_cat] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_document_include_cat" name="gallerylink_document_include_cat" value="<?php echo get_option('gallerylink_document')[include_cat] ?>" size="15" />
					</td>
					<td align="left" valign="middle">
						<div><b><font color="red"><?php _e('Use only', 'gallerylink'); ?> type=&#39;media&#39;</font></b></div>
						<?php _e('Category you want to include. Only one.', 'gallerylink'); ?>
				...
				<tr>
					...
					<td align="center" valign="middle" colspan="6">
						<input type="text" id="gallerylink_exclude_cat" name="gallerylink_exclude_cat" value="<?php echo get_option('gallerylink_exclude')[cat] ?>" size="90" />
					</td>
					<td align="left" valign="middle">
						<div><b><font color="red"><?php _e('Use only', 'gallerylink'); ?> type=&#39;media&#39;</font></b></div>
						<?php _e('Category you want to exclude. More than one, specified separated by |.', 'gallerylink'); ?>
				...
				<tr>
					<td align="center" valign="middle"><b>exclude_file</b></td>
					<td align="center" valign="middle" colspan="6">
						<input type="text" id="gallerylink_exclude_file" name="gallerylink_exclude_file" value="<?php echo get_option('gallerylink_exclude')[file] ?>" size="90" />
					</td>
					<td align="left" valign="middle">
						<div><b><font color="red"><?php _e('Use only', 'gallerylink'); ?> type=&#39;dir&#39;</font></b></div>
						<?php _e('File you want to exclude. More than one, specified separated by |.', 'gallerylink'); ?>
				...
				<tr>
					<td align="center" valign="middle"><b>exclude_dir</b></td>
					<td align="center" valign="middle" colspan="6">
						<input type="text" id="gallerylink_exclude_dir" name="gallerylink_exclude_dir" value="<?php echo get_option('gallerylink_exclude')[dir] ?>" size="90" />
					</td>
					<td align="left" valign="middle">
						<div><b><font color="red"><?php _e('Use only', 'gallerylink'); ?> type=&#39;dir&#39;</font></b></div>
						<?php _e('Directory you want to exclude. More than one, specified separated by |.', 'gallerylink'); ?>
				...
				<tr>
					<td align="center" valign="middle"><b>generate_rssfeed</b></td>
					<td align="center" valign="middle">
					<?php $target_all_generate_rssfeed = get_option('gallerylink_all')[generate_rssfeed]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_generate_rssfeed = get_option('gallerylink_album')[generate_rssfeed]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_generate_rssfeed = get_option('gallerylink_movie')[generate_rssfeed]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_generate_rssfeed = get_option('gallerylink_music')[generate_rssfeed]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_generate_rssfeed = get_option('gallerylink_slideshow')[generate_rssfeed]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_generate_rssfeed = get_option('gallerylink_document')[generate_rssfeed]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>rssname</b></td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_all_rssname" name="gallerylink_all_rssname" value="<?php echo get_option('gallerylink_all')[rssname] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_album_rssname" name="gallerylink_album_rssname" value="<?php echo get_option('gallerylink_album')[rssname] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_movie_rssname" name="gallerylink_movie_rssname" value="<?php echo get_option('gallerylink_movie')[rssname] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_music_rssname" name="gallerylink_music_rssname" value="<?php echo get_option('gallerylink_music')[rssname] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_slideshow_rssname" name="gallerylink_slideshow_rssname" value="<?php echo get_option('gallerylink_slideshow')[rssname] ?>" size="15" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_document_rssname" name="gallerylink_document_rssname" value="<?php echo get_option('gallerylink_document')[rssname] ?>" size="15" />
					</td>
					<td align="left" valign="middle">
						<?php _e('The name of the RSS feed file (Use to widget)', 'gallerylink'); ?>
					</td>
				...
				<tr>
					<td align="center" valign="middle"><b>rssmax</b></td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_all_rssmax" name="gallerylink_all_rssmax" value="<?php echo intval(get_option('gallerylink_all')[rssmax]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_album_rssmax" name="gallerylink_album_rssmax" value="<?php echo intval(get_option('gallerylink_album')[rssmax]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_movie_rssmax" name="gallerylink_movie_rssmax" value="<?php echo intval(get_option('gallerylink_movie')[rssmax]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_music_rssmax" name="gallerylink_music_rssmax" value="<?php echo intval(get_option('gallerylink_music')[rssmax]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_slideshow_rssmax" name="gallerylink_slideshow_rssmax" value="<?php echo intval(get_option('gallerylink_slideshow')[rssmax]) ?>" size="3" />
					</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_document_rssmax" name="gallerylink_document_rssmax" value="<?php echo intval(get_option('gallerylink_document')[rssmax]) ?>" size="3" />
					</td>
					<td align="left" valign="middle">
						<?php _e('Syndication feeds show the most recent (Use to widget)', 'gallerylink') ?>
					</td>
				...
				<tr>
					<td align="center" valign="middle"><b>filesize_show</b></td>
					<td align="center" valign="middle">
					<?php $target_all_filesize_show = get_option('gallerylink_all')[filesize_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_filesize_show = get_option('gallerylink_album')[filesize_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_filesize_show = get_option('gallerylink_movie')[filesize_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_filesize_show = get_option('gallerylink_music')[filesize_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_filesize_show = get_option('gallerylink_slideshow')[filesize_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_filesize_show = get_option('gallerylink_document')[filesize_show]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>stamptime_show</b></td>
					<td align="center" valign="middle">
					<?php $target_all_stamptime_show = get_option('gallerylink_all')[stamptime_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_stamptime_show = get_option('gallerylink_album')[stamptime_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_stamptime_show = get_option('gallerylink_movie')[stamptime_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_stamptime_show = get_option('gallerylink_music')[stamptime_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_stamptime_show = get_option('gallerylink_slideshow')[stamptime_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_stamptime_show = get_option('gallerylink_document')[stamptime_show]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>selectbox_show</b></td>
					<td align="center" valign="middle">
					<?php $target_all_selectbox_show = get_option('gallerylink_all')[selectbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_selectbox_show = get_option('gallerylink_album')[selectbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_selectbox_show = get_option('gallerylink_movie')[selectbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_selectbox_show = get_option('gallerylink_music')[selectbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_selectbox_show = get_option('gallerylink_slideshow')[selectbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_selectbox_show = get_option('gallerylink_document')[selectbox_show]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>pagelinks_show</b></td>
					<td align="center" valign="middle">
					<?php $target_all_pagelinks_show = get_option('gallerylink_all')[pagelinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_pagelinks_show = get_option('gallerylink_album')[pagelinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_pagelinks_show = get_option('gallerylink_movie')[pagelinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_pagelinks_show = get_option('gallerylink_music')[pagelinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_pagelinks_show = get_option('gallerylink_slideshow')[pagelinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_pagelinks_show = get_option('gallerylink_document')[pagelinks_show]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>sortlinks_show</b></td>
					<td align="center" valign="middle">
					<?php $target_all_sortlinks_show = get_option('gallerylink_all')[sortlinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_sortlinks_show = get_option('gallerylink_album')[sortlinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_sortlinks_show = get_option('gallerylink_movie')[sortlinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_sortlinks_show = get_option('gallerylink_music')[sortlinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_sortlinks_show = get_option('gallerylink_slideshow')[sortlinks_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_sortlinks_show = get_option('gallerylink_document')[sortlinks_show]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>searchbox_show</b></td>
					<td align="center" valign="middle">
					<?php $target_all_searchbox_show = get_option('gallerylink_all')[searchbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_searchbox_show = get_option('gallerylink_album')[searchbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_searchbox_show = get_option('gallerylink_movie')[searchbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_searchbox_show = get_option('gallerylink_music')[searchbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_searchbox_show = get_option('gallerylink_slideshow')[searchbox_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_searchbox_show = get_option('gallerylink_document')[searchbox_show]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>rssicon_show</b></td>
					<td align="center" valign="middle">
					<?php $target_all_rssicon_show = get_option('gallerylink_all')[rssicon_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_rssicon_show = get_option('gallerylink_album')[rssicon_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_rssicon_show = get_option('gallerylink_movie')[rssicon_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_rssicon_show = get_option('gallerylink_music')[rssicon_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_rssicon_show = get_option('gallerylink_slideshow')[rssicon_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_rssicon_show = get_option('gallerylink_document')[rssicon_show]; ?>
				...
				<tr>
					<td align="center" valign="middle"><b>credit_show</b></td>
					<td align="center" valign="middle">
					<?php $target_all_credit_show = get_option('gallerylink_all')[credit_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_album_credit_show = get_option('gallerylink_album')[credit_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_movie_credit_show = get_option('gallerylink_movie')[credit_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_music_credit_show = get_option('gallerylink_music')[credit_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_slideshow_credit_show = get_option('gallerylink_slideshow')[credit_show]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_document_credit_show = get_option('gallerylink_document')[credit_show]; ?>
		...
		<div class="wrap">
			...
			<tbody>
				...
				<tr>
					...
					<?php $target_movie_container = get_option('gallerylink_movie')[container]; ?>
				...
				<tr>
					<td align="center" valign="middle" colspan="8">
					<?php $target_css_pc_listthumbsize = get_option('gallerylink_css')[pc_listthumbsize]; ?>
				...
				<tr>
					<td align="center" valign="middle" colspan="4">
						<input type="text" id="gallerylink_css_pc_linkbackcolor" name="gallerylink_css_pc_linkbackcolor" value="<?php echo get_option('gallerylink_css')[pc_linkbackcolor] ?>" size="10" />
					</td>
					<td colspan="4"></td>
					<td align="left" valign="middle">
				...
				<tr>
					<td align="center" valign="middle" colspan="4">
						<input type="text" id="gallerylink_css_pc_linkstrcolor" name="gallerylink_css_pc_linkstrcolor" value="<?php echo get_option('gallerylink_css')[pc_linkstrcolor] ?>" size="10" />
					</td>
					<td colspan="4"></td>
					<td align="left" valign="middle">
				...
				<tr>
					<td colspan="4"></td>
					<td align="center" valign="middle" colspan="4">
						<input type="text" id="gallerylink_css_sp_listarrowcolor" name="gallerylink_css_sp_listarrowcolor" value="<?php echo get_option('gallerylink_css')[sp_listarrowcolor] ?>" size="10" />
					</td>
					<td align="left" valign="middle">
				...
				<tr>
					<td colspan="4"></td>
					<td align="center" valign="middle" colspan="4">
						<input type="text" id="gallerylink_css_sp_listbackcolor" name="gallerylink_css_sp_listbackcolor" value="<?php echo get_option('gallerylink_css')[sp_listbackcolor] ?>" size="10" />
					</td>
					<td align="left" valign="middle">
				...
				<tr>
					<td colspan="4"></td>
					<td align="center" valign="middle" colspan="4">
						<input type="text" id="gallerylink_css_sp_listpartitionlinecolor" name="gallerylink_css_sp_listpartitionlinecolor" value="<?php echo get_option('gallerylink_css')[sp_listpartitionlinecolor] ?>" size="10" />
					</td>
					<td align="left" valign="middle">
				...
				<tr>
					<td colspan="4"></td>
					<td align="center" valign="middle" colspan="4">
						<input type="text" id="gallerylink_css_sp_navbackcolor" name="gallerylink_css_sp_navbackcolor" value="<?php echo get_option('gallerylink_css')[sp_navbackcolor] ?>" size="10" />
					</td>
					<td align="left" valign="middle">
				...
				<tr>
					<td colspan="4"></td>
					<td align="center" valign="middle" colspan="4">
						<input type="text" id="gallerylink_css_sp_navpartitionlinecolor" name="gallerylink_css_sp_navpartitionlinecolor" value="<?php echo get_option('gallerylink_css')[sp_navpartitionlinecolor] ?>" size="10" />
					</td>
					<td align="left" valign="middle">
				...
				<tr>
					<td colspan="4"></td>
					<td align="center" valign="middle" colspan="4">
						<input type="text" id="gallerylink_css_sp_navstrcolor" name="gallerylink_css_sp_navstrcolor" value="<?php echo get_option('gallerylink_css')[sp_navstrcolor] ?>" size="10" />
					</td>
					<td align="left" valign="middle">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center" valign="middle">
						<textarea id="gallerylink_useragent_tb" name="gallerylink_useragent_tb" rows="4" cols="120"><?php echo get_option('gallerylink_useragent')[tb] ?></textarea>
					</td>
				...
				<tr>
					...
					<td align="center" valign="middle">
						<textarea id="gallerylink_useragent_sp" name="gallerylink_useragent_sp" rows="4" cols="120"><?php echo get_option('gallerylink_useragent')[sp] ?></textarea>
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle"><?php _e('for Japanese mobile phone', 'gallerylink'); ?></td>
					<td align="center" valign="middle">
						<textarea id="gallerylink_useragent_mb" name="gallerylink_useragent_mb" rows="4" cols="120"><?php echo get_option('gallerylink_useragent')[mb] ?></textarea>
					</td>
				</tr>
			</tbody>
			</table>
		...
		<div class="wrap">
			...
			<tbody>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_transition = get_option('gallerylink_colorbox')[transition]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_nivoslider_effect = get_option('gallerylink_nivoslider')[effect]; ?>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_photoswipe_fadeInSpeed" name="gallerylink_photoswipe_fadeInSpeed" value="<?php echo get_option('gallerylink_photoswipe')[fadeInSpeed] ?>" size="10" />
					</td>
					<td align="center" valign="middle">hideBarsDelay</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_swipebox_hideBarsDelay" name="gallerylink_swipebox_hideBarsDelay" value="<?php echo get_option('gallerylink_swipebox')[hideBarsDelay] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">speed</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_speed" name="gallerylink_colorbox_speed" value="<?php echo get_option('gallerylink_colorbox')[speed] ?>" size="10" />
					</td>
					<td align="center" valign="middle">slices</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_nivoslider_slices" name="gallerylink_nivoslider_slices" value="<?php echo get_option('gallerylink_nivoslider')[slices] ?>" size="10" />
					</td>
					<td align="center" valign="middle">fadeOutSpeed</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_photoswipe_fadeOutSpeed" name="gallerylink_photoswipe_fadeOutSpeed" value="<?php echo get_option('gallerylink_photoswipe')[fadeOutSpeed] ?>" size="10" />
					</td>
				...
				<tr>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_title" name="gallerylink_colorbox_title" value="<?php echo get_option('gallerylink_colorbox')[title] ?>" size="10" />
					</td>
					<td align="center" valign="middle">boxCols</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_nivoslider_boxCols" name="gallerylink_nivoslider_boxCols" value="<?php echo get_option('gallerylink_nivoslider')[boxCols] ?>" size="10" />
					</td>
					<td align="center" valign="middle">slideSpeed</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_photoswipe_slideSpeed" name="gallerylink_photoswipe_slideSpeed" value="<?php echo get_option('gallerylink_photoswipe')[slideSpeed] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">scalePhotos</td>
					<td align="center" valign="middle">
					<?php $target_colorbox_scalePhotos = get_option('gallerylink_colorbox')[scalePhotos]; ?>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_nivoslider_boxRows" name="gallerylink_nivoslider_boxRows" value="<?php echo get_option('gallerylink_nivoslider')[boxRows] ?>" size="10" />
					</td>
					<td align="center" valign="middle">swipeThreshold</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_photoswipe_swipeThreshold" name="gallerylink_photoswipe_swipeThreshold" value="<?php echo get_option('gallerylink_photoswipe')[swipeThreshold] ?>" size="10" />
					</td>
				<tr>
					<td align="center" valign="middle">scrolling</td>
					<td align="center" valign="middle">
					<?php $target_colorbox_scrolling = get_option('gallerylink_colorbox')[scrolling]; ?>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_nivoslider_animSpeed" name="gallerylink_nivoslider_animSpeed" value="<?php echo get_option('gallerylink_nivoslider')[animSpeed] ?>" size="10" />
					</td>
					<td align="center" valign="middle">swipeTimeThreshold</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_photoswipe_swipeTimeThreshold" name="gallerylink_photoswipe_swipeTimeThreshold" value="<?php echo get_option('gallerylink_photoswipe')[swipeTimeThreshold] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">opacity</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_opacity" name="gallerylink_colorbox_opacity" value="<?php echo get_option('gallerylink_colorbox')[opacity] ?>" size="10" />
					</td>
					<td align="center" valign="middle">pauseTime</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_nivoslider_pauseTime" name="gallerylink_nivoslider_pauseTime" value="<?php echo get_option('gallerylink_nivoslider')[pauseTime] ?>" size="10" />
					</td>
					<td align="center" valign="middle">loop</td>
					<td align="center" valign="middle">
					<?php $target_photoswipe_loop = get_option('gallerylink_photoswipe')[loop]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_open = get_option('gallerylink_colorbox')[open]; ?>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_nivoslider_startSlide" name="gallerylink_nivoslider_startSlide" value="<?php echo get_option('gallerylink_nivoslider')[startSlide] ?>" size="10" />
					</td>
					<td align="center" valign="middle">slideshowDelay</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_photoswipe_slideshowDelay" name="gallerylink_photoswipe_slideshowDelay" value="<?php echo get_option('gallerylink_photoswipe')[slideshowDelay] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">returnFocus</td>
					<td align="center" valign="middle">
					<?php $target_colorbox_returnFocus = get_option('gallerylink_colorbox')[returnFocus]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_nivoslider_directionNav = get_option('gallerylink_nivoslider')[directionNav]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_photoswipe_imageScaleMethod = get_option('gallerylink_photoswipe')[imageScaleMethod]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_trapFocus = get_option('gallerylink_colorbox')[trapFocus]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_nivoslider_directionNavHide = get_option('gallerylink_nivoslider')[directionNavHide]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_photoswipe_preventHide = get_option('gallerylink_photoswipe')[preventHide]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_fastIframe = get_option('gallerylink_colorbox')[fastIframe]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_nivoslider_pauseOnHover = get_option('gallerylink_nivoslider')[pauseOnHover]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_photoswipe_backButtonHideEnabled = get_option('gallerylink_photoswipe')[backButtonHideEnabled]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_preloading = get_option('gallerylink_colorbox')[preloading]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_nivoslider_manualAdvance = get_option('gallerylink_nivoslider')[manualAdvance]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_photoswipe_captionAndToolbarHide = get_option('gallerylink_photoswipe')[captionAndToolbarHide]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_overlayClose = get_option('gallerylink_colorbox')[overlayClose]; ?>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_nivoslider_prevText" name="gallerylink_nivoslider_prevText" value="<?php echo get_option('gallerylink_nivoslider')[prevText] ?>" size="10" />
					</td>
					<td align="center" valign="middle">captionAndToolbarHideOnSwipe</td>
					<td align="center" valign="middle">
					<?php $target_photoswipe_captionAndToolbarHideOnSwipe = get_option('gallerylink_photoswipe')[captionAndToolbarHideOnSwipe]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_escKey = get_option('gallerylink_colorbox')[escKey]; ?>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_nivoslider_nextText" name="gallerylink_nivoslider_nextText" value="<?php echo get_option('gallerylink_nivoslider')[nextText] ?>" size="10" />
					</td>
					<td align="center" valign="middle">captionAndToolbarFlipPosition</td>
					<td align="center" valign="middle">
					<?php $target_photoswipe_captionAndToolbarFlipPosition = get_option('gallerylink_photoswipe')[captionAndToolbarFlipPosition]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_arrowKey = get_option('gallerylink_colorbox')[arrowKey]; ?>
					...
					<td align="center" valign="middle">
					<?php $target_nivoslider_randomStart = get_option('gallerylink_nivoslider')[randomStart]; ?>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_photoswipe_captionAndToolbarAutoHideDelay" name="gallerylink_photoswipe_captionAndToolbarAutoHideDelay" value="<?php echo get_option('gallerylink_photoswipe')[captionAndToolbarAutoHideDelay] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">loop</td>
					<td align="center" valign="middle">
					<?php $target_colorbox_loop = get_option('gallerylink_colorbox')[loop]; ?>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_photoswipe_captionAndToolbarOpacity" name="gallerylink_photoswipe_captionAndToolbarOpacity" value="<?php echo get_option('gallerylink_photoswipe')[captionAndToolbarOpacity] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">fadeOut</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_fadeOut" name="gallerylink_colorbox_fadeOut" value="<?php echo get_option('gallerylink_colorbox')[fadeOut] ?>" size="10" />
					</td>
					<td align="center" valign="middle">captionAndToolbarShowEmptyCaptions</td>
					<td align="center" valign="middle">
					<?php $target_photoswipe_captionAndToolbarShowEmptyCaptions = get_option('gallerylink_photoswipe')[captionAndToolbarShowEmptyCaptions]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_closeButton = get_option('gallerylink_colorbox')[closeButton]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_current" name="gallerylink_colorbox_current" value="<?php echo get_option('gallerylink_colorbox')[current] ?>" size="30" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">previous</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_previous" name="gallerylink_colorbox_previous" value="<?php echo get_option('gallerylink_colorbox')[previous] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">next</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_next" name="gallerylink_colorbox_next" value="<?php echo get_option('gallerylink_colorbox')[next] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">close</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_close" name="gallerylink_colorbox_close" value="<?php echo get_option('gallerylink_colorbox')[close] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">width</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_width" name="gallerylink_colorbox_width" value="<?php echo get_option('gallerylink_colorbox')[width] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">height</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_height" name="gallerylink_colorbox_height" value="<?php echo get_option('gallerylink_colorbox')[height] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">innerWidth</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_innerWidth" name="gallerylink_colorbox_innerWidth" value="<?php echo get_option('gallerylink_colorbox')[innerWidth] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">innerHeight</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_innerHeight" name="gallerylink_colorbox_innerHeight" value="<?php echo get_option('gallerylink_colorbox')[innerHeight] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">initialWidth</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_initialWidth" name="gallerylink_colorbox_initialWidth" value="<?php echo get_option('gallerylink_colorbox')[initialWidth] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">initialHeight</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_initialHeight" name="gallerylink_colorbox_initialHeight" value="<?php echo get_option('gallerylink_colorbox')[initialHeight] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">maxWidth</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_maxWidth" name="gallerylink_colorbox_maxWidth" value="<?php echo get_option('gallerylink_colorbox')[maxWidth] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">maxHeight</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_maxHeight" name="gallerylink_colorbox_maxHeight" value="<?php echo get_option('gallerylink_colorbox')[maxHeight] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">slideshow</td>
					<td align="center" valign="middle">
					<?php $target_colorbox_slideshow = get_option('gallerylink_colorbox')[slideshow]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_slideshowSpeed" name="gallerylink_colorbox_slideshowSpeed" value="<?php echo get_option('gallerylink_colorbox')[slideshowSpeed] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">slideshowAuto</td>
					<td align="center" valign="middle">
					<?php $target_colorbox_slideshowAuto = get_option('gallerylink_colorbox')[slideshowAuto]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_slideshowStart" name="gallerylink_colorbox_slideshowStart" value="<?php echo get_option('gallerylink_colorbox')[slideshowStart] ?>" size="20" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">slideshowStop</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_slideshowStop" name="gallerylink_colorbox_slideshowStop" value="<?php echo get_option('gallerylink_colorbox')[slideshowStop] ?>" size="20" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">fixed</td>
					<td align="center" valign="middle">
					<?php $target_colorbox_fixed = get_option('gallerylink_colorbox')[fixed]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_top" name="gallerylink_colorbox_top" value="<?php echo get_option('gallerylink_colorbox')[top] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">bottom</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_bottom" name="gallerylink_colorbox_bottom" value="<?php echo get_option('gallerylink_colorbox')[bottom] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">left</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_left" name="gallerylink_colorbox_left" value="<?php echo get_option('gallerylink_colorbox')[left] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">right</td>
					<td align="center" valign="middle">
						<input type="text" id="gallerylink_colorbox_right" name="gallerylink_colorbox_right" value="<?php echo get_option('gallerylink_colorbox')[right] ?>" size="10" />
					</td>
				</tr>
				<tr>
					<td align="center" valign="middle">reposition</td>
					<td align="center" valign="middle">
					<?php $target_colorbox_reposition = get_option('gallerylink_colorbox')[reposition]; ?>
				...
				<tr>
					...
					<td align="center" valign="middle">
					<?php $target_colorbox_retinaImage = get_option('gallerylink_colorbox')[retinaImage]; ?>

...
class GalleryLinkAdmin {
	...
	<div id="gallerylink-admin-tabs">
	  <ul>
		...
		<li><a href="#gallerylink-admin-tabs-11"><?php _e('Donate to this plugin &#187;'); ?></a></li>
	<!--
		<li><a href="#gallerylink-admin-tabs-12">FAQ</a></li>
	 -->
	  </ul>
...
AddType application/vnd.ms-powerpoint.slide.macroEnabled.12 sldm
		...
		<div class="wrap">
			...
			<a style="text-decoration: none;" href="https://wordpress.org/support/plugin/gallerylink" target="_blank"><?php _e('Support Forums') ?></a> |
			<a style="text-decoration: none;" href="https://wordpress.org/support/view/plugin-reviews/gallerylink" target="_blank"><?php _e('Reviews', 'gallerylink') ?></a>
			</h4>
	...
	<!--
	  <div id="gallerylink-admin-tabs-12">
		<div class="wrap">
		<h2>FAQ</h2>
	...
	function options_updated($tabs){
		...
		switch ($tabs) {
			...
			case 6:
				if ( !empty($_POST['Default']) ) {
					update_option( 'gallerylink_slideshow', $slideshow_reset_tbl );
					echo '<div class="updated"><ul><li>'.__('Settings').__('Slideshow', 'gallerylink').' --> '.__('Default').' --> '.__('Changes saved.').'</li></ul></div>';
				} else {
					$slideshow_tbl = array(
					...
					echo '<div class="updated"><ul><li>'.__('Settings').__('Slideshow', 'gallerylink').' --> '.__('Changes saved.').'</li></ul></div>';
				}
				break;
			case 7:
				if ( !empty($_POST['Default']) ) {
